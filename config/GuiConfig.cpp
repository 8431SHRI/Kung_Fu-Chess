...
cv::Scalar GuiConfig::SELECTION_COLOR =
    cv::Scalar(0,255,255,255);

cv::Scalar GuiConfig::LEGAL_MOVE_COLOR =
    cv::Scalar(0,220,0,255);

cv::Scalar GuiConfig::GAME_OVER_OVERLAY_COLOR =
    cv::Scalar(0,0,0,170);

cv::Scalar GuiConfig::GAME_OVER_TEXT_COLOR =
    cv::Scalar(255,255,255,255);
const char* GuiConfig::GAME_OVER_TEXT =
    "GAME OVER";
